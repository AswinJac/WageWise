...
<body style="background-image: url('admin\Payroll.jpg'); background-size: cover; background-position: center; background-repeat: no-repeat;">

   <div class="h-100 d-flex justify-content-center align-items-center">
       <div class='w-100'>
        <h1 class="py-5 text-center" style="color: black;">𝖯𝖺𝗒𝗋𝗈𝗅𝗅 𝖬𝖺𝗇𝖺𝗀𝖾𝗆𝖾𝗇𝗍 𝖲𝗒𝗌𝗍𝖾𝗆</h1>
